...
;
var gf0 = gf(), gf1 = gf([1]), _121665 = gf([0xdb41, 1]), D = gf([
    0x78a3,
    0x1359,
    0x4dca,
    0x75eb,
 ...
 * @returns
 */
export function signMessage(secretKey, msg, opt_random) {
 ...
 * @returns Message
 */
export function openMessage(publicKey, signedMsg) {
 ...
 * @returns
 */
export function sign(secretKey, msg, opt_random) {
